...
const std::string m2Manipulator::VIEW_ID =
    "org.mitk.views.matchpoint.registration.manipulator";

const std::string m2Manipulator::HelperNodeName =
    "RegistrationManipulationEvaluationHelper";

m2Manipulator::m2Manipulator()
...
void m2Manipulator::SetFocus()
{

}

void m2Manipulator::Error(QString msg)
{
	mitk::StatusBar::GetInstance()->DisplayErrorText(msg.toLatin1());
	MITK_ERROR << msg.toStdString().c_str();
}

void m2Manipulator::CreateQtPartControl(QWidget* parent)
{
  ...
  connect(m_Controls.registrationNodeSelector, &QmitkAbstractNodeSelectionWidget::CurrentSelectionChanged, this, &m2Manipulator::OnNodeSelectionChanged);
  connect(m_Controls.movingNodeSelector, &QmitkAbstractNodeSelectionWidget::CurrentSelectionChanged, this, &m2Manipulator::OnNodeSelectionChanged);
  connect(m_Controls.targetNodeSelector, &QmitkAbstractNodeSelectionWidget::CurrentSelectionChanged, this, &m2Manipulator::OnNodeSelectionChanged);
...
void m2Manipulator::RenderWindowPartActivated(mitk::IRenderWindowPart* renderWindowPart)
{
  this->m_SliceChangeListener.RenderWindowPartActivated(renderWindowPart);
}

void m2Manipulator::RenderWindowPartDeactivated(
  mitk::IRenderWindowPart* renderWindowPart)
{
  this->m_SliceChangeListener.RenderWindowPartDeactivated(renderWindowPart);
}

void m2Manipulator::ConfigureNodePredicates()
{
...
void m2Manipulator::CheckInputs()
{
...
void m2Manipulator::OnRegSourceChanged()
{
  this->CheckInputs();
  this->ConfigureControls();
}

void m2Manipulator::OnNodeSelectionChanged(QList<mitk::DataNode::Pointer> /*nodes*/)
{
  this->CheckInputs();
  this->ConfigureControls();
}

void m2Manipulator::NodeRemoved(const mitk::DataNode* node)
{
...
void m2Manipulator::ConfigureControls()
{
  if (!m_activeManipulation)
  {
...
void m2Manipulator::InitSession()
{
...
void m2Manipulator::StopSession()
{
...
void m2Manipulator::OnRegistrationChanged()
{
  if (this->m_EvalNode.IsNotNull())
  {
...
void m2Manipulator::OnSliceChanged()
{
...
void m2Manipulator::OnSettingsChanged(mitk::DataNode*)
{
	this->GetRenderWindowPart()->RequestUpdate();
}

void m2Manipulator::OnStartBtnPushed()
{
  this->InitSession();
  this->OnSliceChanged();
...
void m2Manipulator::OnCancelBtnPushed()
{
  this->StopSession();
...
void m2Manipulator::OnStoreBtnPushed()
{
...
void m2Manipulator::OnMapResultIsAvailable(mitk::BaseData::Pointer spMappedData,
...
void m2Manipulator::OnCenterTypeChanged(int index)
{
...
void m2Manipulator::ConfigureTransformCenter(int centerType)
{
  if (centerType == 0)
  { //image center
