...
//Qmitk
#include "m2ManipulationWidget.h"
...
m2ManipulationWidget::m2ManipulationWidget(QWidget *parent)
...
m2ManipulationWidget::~m2ManipulationWidget()
= default;

void m2ManipulationWidget::Initialize()
{
  this->ResetTransforms();
  this->InitControls();
};

void m2ManipulationWidget::Initialize(MAPRegistrationType* precedingRegistration)
{
  this->ResetTransforms();
...
void m2ManipulationWidget::Initialize(const mitk::Point3D& movingReference, const mitk::Point3D& targetReference)
{
  this->ResetTransforms();
...
void m2ManipulationWidget::ResetTransforms()
{
...
void m2ManipulationWidget::SetCenterOfRotation(const mitk::Point3D& center)
{
...
void m2ManipulationWidget::SetCenterOfRotationIsRelativeToTarget(bool targetRelative)
{
...
void m2ManipulationWidget::InitControls()
{
  this->ConfigureTransformCenter();
  ...
  this->slideTransZ->hide();
  this->labelTransZ->hide();
  this->sbTransZ->hide();
  this->slideRotX->hide();
  this->slideRotY->hide();
  this->labelRotX->hide();
  ...
  this->groupScale->hide();
  
  this->UpdateTransformWidgets();
};

void m2ManipulationWidget::UpdateTransformWidgets()
{
  this->m_internalUpdate = true;
...
void m2ManipulationWidget::UpdateTransform(bool updateRotation)
{
  if (updateRotation)
  {
...
map::core::RegistrationBase* m2ManipulationWidget::GetInterimRegistration() const
{
  return this->m_CurrentRegistration.GetPointer();
};

map::core::RegistrationBase::Pointer m2ManipulationWidget::GenerateRegistration() const
{
...
void m2ManipulationWidget::OnRotXChanged(double x)
{
  if (!m_internalUpdate)
  {
...
void m2ManipulationWidget::OnRotXSlideChanged(int x)
{
  if (!m_internalUpdate)
  {
...
void m2ManipulationWidget::OnRotYChanged(double y)
{
  if (!m_internalUpdate)
  {
    m_internalUpdate = true;
...
void m2ManipulationWidget::OnRotYSlideChanged(int y)
{
  if (!m_internalUpdate)
  {
...
void m2ManipulationWidget::OnRotZChanged(double z)
{
  if (!m_internalUpdate)
  {
    m_internalUpdate = true;
...
void m2ManipulationWidget::OnRotZSlideChanged(int z)
{
  if (!m_internalUpdate)
  {
...
void m2ManipulationWidget::OnTransXChanged(double x)
{
  if (!m_internalUpdate)
  {
    m_internalUpdate = true;
...
void m2ManipulationWidget::OnTransXSlideChanged(int x)
{
  if (!m_internalUpdate)
  {
...
void m2ManipulationWidget::OnTransYChanged(double y)
{
  if (!m_internalUpdate)
  {
    m_internalUpdate = true;
...
void m2ManipulationWidget::OnTransYSlideChanged(int y)
{
  if (!m_internalUpdate)
  {
...
void m2ManipulationWidget::OnTransZChanged(double z)
{
  if (!m_internalUpdate)
  {
    m_internalUpdate = true;
...
void m2ManipulationWidget::OnTransZSlideChanged(int z)
{
  if (!m_internalUpdate)
  {
...
void m2ManipulationWidget::ConfigureTransformCenter()
{
