...
template <class T>
template <class U>
void m2::Morphology<T>::apply(std::vector<T> &y, unsigned int s, std::vector<T> &output, U cmp) noexcept
{
  std::vector<T> f, g, h;
...
template <class T>
void m2::Morphology<T>::dilation(std::vector<T> &y, unsigned int s, std::vector<T> &output) noexcept
{
  m2::Morphology<T>::apply<std::less<>>(y, s, output);
}

template <class T>
void m2::Morphology<T>::erosion(std::vector<T> &y, unsigned int s, std::vector<T> &output) noexcept
{
  m2::Morphology<T>::apply<std::greater<>>(y, s, output);
}
