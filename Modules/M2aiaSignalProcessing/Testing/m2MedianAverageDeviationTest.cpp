...
class m2MedianAverageDeviationTestSuite : public mitk::TestFixture
{
  CPPUNIT_TEST_SUITE(m2MedianAverageDeviationTestSuite);
...
MITK_TEST_SUITE_REGISTRATION(m2MedianAverageDeviation)
